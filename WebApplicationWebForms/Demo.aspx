<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Demo.aspx.cs" Inherits="WebApplicationWebForms.Demo Trace=True" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:mydbtutoConnectionString2 %>" SelectCommand="SELECT * FROM [Tutorial]" 
                UpdateCommand="UPDATE [dbo].[Tutorial]   SET [TutorialID] = @TutorialID,[TutorialName] = @TutorialName WHERE [TutorialID]  = @TutorialID;"></asp:SqlDataSource>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                SelectCommand="SELECT * FROM [Tutorial]" 
                UpdateCommand="UPDATE Tutorial SET TutorialID =@TutorialID ,TutorialName = @TutorialName where TutorialID =@TutorialID">
            </asp:SqlDataSource>
            <br />
